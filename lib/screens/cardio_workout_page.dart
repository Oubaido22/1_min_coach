...
class _CardioWorkoutPageState extends State<CardioWorkoutPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final exercises = widget.workoutPlan.getCardioDay(currentDay);
    final isRestDay = widget.workoutPlan.isRestDay(currentDay, 'cardio');
            ...
            Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isRest = widget.workoutPlan.isRestDay(day, 'cardio');
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: isRest && isSelected
                            ? Border.all(color: const Color(0xFF6A0DAD), width: 2)
                            : null,
                      ),
                      child: Column(
                        ...
                        children: [
                          ...
                          if (isRest)
                            Icon(
                              Icons.bedtime,
                              size: 12,
                              color: isSelected ? const Color(0xFF6A0DAD) : const Color(0xFF9E9E9E),
                            ),
                        ],
                      ),
                    ),
  ...
  void _showStartWorkoutDialog(List<String> exercises) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Ready to begin your ${exercises.length} cardio exercises?',
          style: GoogleFonts.inter(
            color: Colors.white,
          ),
        ),
          ...
          TextButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Cardio workout started! (Feature coming soon)'),
